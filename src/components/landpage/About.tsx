  ...
  return (
    <div className="bg-white pb-10">
      <div
        ref={ref1}
        id="about"
        className={`w-40 ml-12 pt-20  text-xl font-bold leading-8 lg:pt-44 md:w-60 md:ml-48 md:text-4xl lg:ml-96 transition-all duration-700 ${
      ...
      <div className="flex-1 m-2 my-14 transition-all duration-1000">
      ...
      <div className="w-full flex justify-start mb-12 transition-all duration-1000 ">
